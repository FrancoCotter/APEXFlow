...
export const translations = {
  en: {
    ...
    convertingRecordingToInstrument: 'Converting recording to instrument...',
    extendingInstrumentClip: 'Extending instrument clip {current}/{total}...',
    ...
    repaintAudioHelp: 'Repaint only the selected time range while preserving the rest of the source audio.',
    legoAudioHelp: 'Add a selected instrument or vocal track to the source audio. Base models only.',
    extractAudioHelp: 'Extract a selected instrument or vocal track from the source audio. Base models only.',
    completeAudioHelp: 'Complete the source audio with the selected missing track classes. Base models only.',
    useSourceAs: 'Use source as',
    record: 'Record',
    stopRecording: 'Stop',
    preparingMicrophone: 'Waiting for microphone permission...',
    uploadingRecording: 'Saving recording...',
    microphonePermissionDenied: 'Microphone permission was not granted, so recording is unavailable. You can still choose audio from the library or upload it.',
    microphoneUnavailable: 'The microphone could not be started. Check the browser and system microphone settings, then try again.',
    microphoneDeviceUnavailable: 'Microphone permission is enabled, but no readable input device is available. Close other audio apps or check the remote-session microphone, then try again.',
    recordingFailed: 'Recording stopped because of a microphone error.',
    recordingTooShort: 'The recording was too short. Please record a slightly longer clip.',
    recordingUploadFailed: 'The recording was captured but could not be saved. Please try again.',
    recordingSignInRequired: 'Please sign in before recording audio.',
    recordedAudio: 'Recorded melody',
    targetInstrument: 'Target Instrument',
    selectInstrument: 'Select an instrument',
    recordingInstrumentHelp: 'The recording will be covered with the selected instrument and your Style caption.',
    recordingInstrumentRequired: 'Select an instrument for this recording.',
    recordingDurationLimit: 'Recorded instrument clips are limited to 90 seconds.',
    recordingDurationHelp: 'Recorded instrument clips: maximum 90 seconds',
    instrumentGrandPiano: 'Grand Piano',
    instrumentElectricPiano: 'Electric Piano',
    instrumentOrgan: 'Organ',
    instrumentHarpsichord: 'Harpsichord',
    instrumentCelesta: 'Celesta',
    instrumentAcousticGuitar: 'Acoustic Guitar',
    instrumentNylonGuitar: 'Nylon-string Guitar',
    instrumentElectricGuitar: 'Electric Guitar',
    instrumentDistortedGuitar: 'Distorted Electric Guitar',
    instrumentElectricBass: 'Electric Bass',
    instrumentUprightBass: 'Upright Bass',
    instrumentHarp: 'Harp',
    instrumentViolin: 'Violin',
    instrumentViola: 'Viola',
    instrumentCello: 'Cello',
    instrumentDoubleBass: 'Double Bass',
    instrumentStringEnsemble: 'String Ensemble',
    instrumentPizzicatoStrings: 'Pizzicato Strings',
    instrumentFlute: 'Flute',
    instrumentClarinet: 'Clarinet',
    instrumentOboe: 'Oboe',
    instrumentBassoon: 'Bassoon',
    instrumentSaxophone: 'Saxophone',
    instrumentEnglishHorn: 'English Horn',
    instrumentTrumpet: 'Trumpet',
    instrumentTrombone: 'Trombone',
    instrumentFrenchHorn: 'French Horn',
    instrumentTuba: 'Tuba',
    instrumentBrassEnsemble: 'Brass Ensemble',
    instrumentAcousticDrums: 'Acoustic Drums',
    instrumentElectronicDrums: 'Electronic Drums',
    instrumentDrumMachine: 'Drum Machine',
    instrumentPercussion: 'Percussion',
    instrumentTimpani: 'Timpani',
    instrumentMarimba: 'Marimba',
    instrumentVibraphone: 'Vibraphone',
    instrumentXylophone: 'Xylophone',
    instrumentSynthLead: 'Synth Lead',
    instrumentSynthBass: 'Synth Bass',
    instrumentSynthPad: 'Synth Pad',
    instrumentSynthPluck: 'Synth Pluck',
    recordingLyricsLockedTitle: 'Lyrics are paused for this recording',
    recordingLyricsLockedHelp: 'This recorded melody will be used as the source for instrument generation. Lyrics are hidden to prevent accidental input in the wrong field.',
    useLyricsAnyway: 'Use lyrics anyway',
    stemStart: 'Stem Start',
    stemEnd: 'Stem End',
    trackToAdd: 'Track to Add',
    trackToExtract: 'Track to Extract',
    baseOnly: 'Base only',
    sourceAudioRequired: 'This task requires source audio or audio codes.',
    baseModelRequired: 'Lego, Extract, and Complete require a Base model.',
    trackSelectionRequired: 'Select a track before generating.',
    completeTracksRequired: 'Select at least one track class to complete.',
  ...
  zh: {
    ...
    bannerFormats: '推荐尺寸：1500x500px • JPG、PNG、WebP、GIF • 最大 50MB • 如果图片里有人脸，建议头部和脸放在偏上居中的区域',
    bio: '个人简介',
    ...
    repaintAudioHelp: '仅重绘选定的时间范围，并保留源音频的其他部分。',
    legoAudioHelp: '为源音频补入选定的乐器或人声音轨，仅支持 Base 模型。',
    extractAudioHelp: '从源音频中提取选定的乐器或人声音轨，仅支持 Base 模型。',
    completeAudioHelp: '按照选定的缺失音轨类别补全源音频，仅支持 Base 模型。',
    useSourceAs: '将源音频用于',
    record: '录音',
    stopRecording: '结束录音',
    preparingMicrophone: '正在等待麦克风授权…',
    uploadingRecording: '正在保存录音…',
    microphonePermissionDenied: '没有获得麦克风权限，因此无法录音。你仍然可以从库中选择或上传音频。',
    microphoneUnavailable: '无法启动麦克风，请检查浏览器与系统的麦克风设置后重试。',
    microphoneDeviceUnavailable: '麦克风权限已经开启，但没有可读取的输入设备。请关闭占用麦克风的应用，或检查远程会话的麦克风转发后重试。',
    recordingFailed: '麦克风发生错误，录音已停止。',
    recordingTooShort: '录音时间太短，请录制一个稍长的片段。',
    recordingUploadFailed: '录音已完成，但保存失败，请重试。',
    recordingSignInRequired: '请先登录，然后再录制音频。',
    recordedAudio: '录制的旋律',
    targetInstrument: '目标乐器',
    selectInstrument: '选择一种乐器',
    recordingInstrumentHelp: '录音将使用所选乐器和你填写的 Style 描述进行 Cover。',
    recordingInstrumentRequired: '请为这段录音选择一种乐器。',
    recordingDurationLimit: '录音乐器片段最长为 90 秒。',
    recordingDurationHelp: '录音乐器片段：最长 90 秒',
    instrumentGrandPiano: '三角钢琴',
    instrumentElectricPiano: '电钢琴',
    instrumentOrgan: '风琴',
    instrumentHarpsichord: '羽管键琴',
    instrumentCelesta: '钢片琴',
    instrumentAcousticGuitar: '原声吉他',
    instrumentNylonGuitar: '尼龙弦吉他',
    instrumentElectricGuitar: '电吉他',
    instrumentDistortedGuitar: '失真电吉他',
    instrumentElectricBass: '电贝斯',
    instrumentUprightBass: '低音提琴',
    instrumentHarp: '竖琴',
    instrumentViolin: '小提琴',
    instrumentViola: '中提琴',
    instrumentCello: '大提琴',
    instrumentDoubleBass: '倍低音提琴',
    instrumentStringEnsemble: '弦乐合奏',
    instrumentPizzicatoStrings: '拨奏弦乐',
    instrumentFlute: '长笛',
    instrumentClarinet: '单簧管',
    instrumentOboe: '双簧管',
    instrumentBassoon: '巴松管',
    instrumentSaxophone: '萨克斯',
    instrumentEnglishHorn: '英国管',
    instrumentTrumpet: '小号',
    instrumentTrombone: '长号',
    instrumentFrenchHorn: '法国号',
    instrumentTuba: '大号',
    instrumentBrassEnsemble: '铜管合奏',
    instrumentAcousticDrums: '原声鼓组',
    instrumentElectronicDrums: '电子鼓',
    instrumentDrumMachine: '鼓机',
    instrumentPercussion: '打击乐',
    instrumentTimpani: '定音鼓',
    instrumentMarimba: '马林巴',
    instrumentVibraphone: '颤音琴',
    instrumentXylophone: '木琴',
    instrumentSynthLead: '合成器主音',
    instrumentSynthBass: '合成器贝斯',
    instrumentSynthPad: '合成器铺底',
    instrumentSynthPluck: '拨弦合成器',
    recordingLyricsLockedTitle: '录音片段模式下已暂停歌词输入',
    recordingLyricsLockedHelp: '这段录制的旋律会作为生成乐器的源音频。歌词输入暂时隐藏，以免误填到错误的位置。',
    useLyricsAnyway: '仍然使用歌词',
    stemStart: '音轨开始',
    stemEnd: '音轨结束',
    trackToAdd: '要补入的音轨',
    trackToExtract: '要提取的音轨',
    baseOnly: '仅 Base',
    sourceAudioRequired: '此任务需要源音频或音频编码。',
    baseModelRequired: 'Lego、提取和补全任务需要 Base 模型。',
    trackSelectionRequired: '生成前请选择一个音轨。',
    completeTracksRequired: '请至少选择一个要补全的音轨类别。',
    ...
    convertingRecordingToInstrument: '正在将录音转换为乐器...',
    extendingInstrumentClip: '正在延长乐器片段 {current}/{total}...',
  ...
  ja: {
    ...
    repaintAudioHelp: '選択した時間範囲のみを再生成し、ソース音声の残りを保持します。',
    legoAudioHelp: '選択した楽器またはボーカルトラックをソース音声に追加します。Baseモデル専用です。',
    extractAudioHelp: '選択した楽器またはボーカルトラックをソース音声から抽出します。Baseモデル専用です。',
    completeAudioHelp: '選択した不足トラックのクラスでソース音声を補完します。Baseモデル専用です。',
    useSourceAs: 'ソースの用途',
    record: '録音',
    stopRecording: '停止',
    preparingMicrophone: 'マイクの許可を待っています…',
    uploadingRecording: '録音を保存しています…',
    microphonePermissionDenied: 'マイクの使用が許可されていないため録音できません。ライブラリから選択するか、音声をアップロードできます。',
    microphoneUnavailable: 'マイクを開始できませんでした。ブラウザとシステムのマイク設定を確認して再試行してください。',
    microphoneDeviceUnavailable: 'マイクの許可は有効ですが、読み取り可能な入力デバイスがありません。他の音声アプリを閉じるか、リモート接続のマイク転送を確認してください。',
    recordingFailed: 'マイクエラーのため録音を停止しました。',
    recordingTooShort: '録音が短すぎます。もう少し長く録音してください。',
    recordingUploadFailed: '録音は完了しましたが保存できませんでした。もう一度お試しください。',
    recordingSignInRequired: '録音する前にサインインしてください。',
    recordedAudio: '録音したメロディー',
    targetInstrument: 'ターゲット楽器',
    selectInstrument: '楽器を選択',
    recordingInstrumentHelp: '選択した楽器とStyleの説明を使って録音をCoverします。',
    recordingInstrumentRequired: 'この録音に使用する楽器を選択してください。',
    recordingDurationLimit: '録音から生成する楽器クリップは最大90秒です。',
    recordingDurationHelp: '録音乐器クリップ：最大90秒',
    instrumentGrandPiano: 'グランドピアノ',
    instrumentElectricPiano: 'エレクトリックピアノ',
    instrumentOrgan: 'オルガン',
    instrumentHarpsichord: 'ハープシコード',
    instrumentCelesta: 'チェレスタ',
    instrumentAcousticGuitar: 'アコースティックギター',
    instrumentNylonGuitar: 'ナイロン弦ギター',
    instrumentElectricGuitar: 'エレクトリックギター',
    instrumentDistortedGuitar: 'ディストーションギター',
    instrumentElectricBass: 'エレクトリックベース',
    instrumentUprightBass: 'アップライトベース',
    instrumentHarp: 'ハープ',
    instrumentViolin: 'バイオリン',
    instrumentViola: 'ビオラ',
    instrumentCello: 'チェロ',
    instrumentDoubleBass: 'コントラバス',
    instrumentStringEnsemble: 'ストリングスアンサンブル',
    instrumentPizzicatoStrings: 'ピチカートストリングス',
    instrumentFlute: 'フルート',
    instrumentClarinet: 'クラリネット',
    instrumentOboe: 'オーボエ',
    instrumentBassoon: 'ファゴット',
    instrumentSaxophone: 'サックス',
    instrumentEnglishHorn: 'イングリッシュホルン',
    instrumentTrumpet: 'トランペット',
    instrumentTrombone: 'トロンボーン',
    instrumentFrenchHorn: 'フレンチホルン',
    instrumentTuba: 'チューバ',
    instrumentBrassEnsemble: 'ブラスアンサンブル',
    instrumentAcousticDrums: 'アコースティックドラム',
    instrumentElectronicDrums: '電子ドラム',
    instrumentDrumMachine: 'ドラムマシン',
    instrumentPercussion: 'パーカッション',
    instrumentTimpani: 'ティンパニ',
    instrumentMarimba: 'マリンバ',
    instrumentVibraphone: 'ビブラフォン',
    instrumentXylophone: 'シロフォン',
    instrumentSynthLead: 'シンセリード',
    instrumentSynthBass: 'シンセベース',
    instrumentSynthPad: 'シンセパッド',
    instrumentSynthPluck: 'シンセプラック',
    recordingLyricsLockedTitle: '録音クリップでは歌詞入力を一時停止しています',
    recordingLyricsLockedHelp: '録音したメロディーを楽器生成のソース音声として使用します。誤入力を防ぐため歌詞欄を非表示にしています。',
    useLyricsAnyway: '歌詞を使用する',
    stemStart: 'ステム開始',
    stemEnd: 'ステム終了',
    trackToAdd: '追加するトラック',
    trackToExtract: '抽出するトラック',
    baseOnly: 'Baseのみ',
    sourceAudioRequired: 'このタスクにはソース音声またはオーディオコードが必要です。',
    baseModelRequired: 'Lego、抽出、補完にはBaseモデルが必要です。',
    trackSelectionRequired: '生成前にトラックを選択してください。',
    completeTracksRequired: '補完するトラッククラスを1つ以上選択してください。',
    ...
    convertingRecordingToInstrument: '録音を楽器に変換中...',
    extendingInstrumentClip: '楽器クリップを延長中 {current}/{total}...',
  ...
  ko: {
    ...
    repaintAudioHelp: '선택한 시간 구간만 다시 생성하고 소스 오디오의 나머지는 유지합니다.',
    legoAudioHelp: '선택한 악기 또는 보컬 트랙을 소스 오디오에 추가합니다. Base 모델 전용입니다.',
    extractAudioHelp: '선택한 악기 또는 보컬 트랙을 소스 오디오에서 추출합니다. Base 모델 전용입니다.',
    completeAudioHelp: '선택한 누락 트랙 클래스로 소스 오디오를 완성합니다. Base 모델 전용입니다.',
    useSourceAs: '소스 사용 방식',
    record: '녹음',
    stopRecording: '중지',
    preparingMicrophone: '마이크 권한을 기다리는 중…',
    uploadingRecording: '녹음을 저장하는 중…',
    microphonePermissionDenied: '마이크 권한이 없어 녹음할 수 없습니다. 라이브러리에서 선택하거나 오디오를 업로드할 수 있습니다.',
    microphoneUnavailable: '마이크를 시작할 수 없습니다. 브라우저와 시스템의 마이크 설정을 확인한 뒤 다시 시도하세요.',
    microphoneDeviceUnavailable: '마이크 권한은 켜져 있지만 읽을 수 있는 입력 장치가 없습니다. 다른 오디오 앱을 닫거나 원격 세션의 마이크 전달 설정을 확인하세요.',
    recordingFailed: '마이크 오류로 녹음이 중지되었습니다.',
    recordingTooShort: '녹음이 너무 짧습니다. 조금 더 길게 녹음해 주세요.',
    recordingUploadFailed: '녹음은 완료되었지만 저장하지 못했습니다. 다시 시도하세요.',
    recordingSignInRequired: '오디오를 녹음하기 전에 로그인해 주세요.',
    recordedAudio: '녹음한 멜로디',
    targetInstrument: '대상 악기',
    selectInstrument: '악기 선택',
    recordingInstrumentHelp: '선택한 악기와 Style 설명을 사용해 녹음을 Cover합니다.',
    recordingInstrumentRequired: '이 녹음에 사용할 악기를 선택하세요.',
    recordingDurationLimit: '녹음 악기 클립은 최대 90초까지 생성할 수 있습니다.',
    recordingDurationHelp: '녹음 악기 클립: 최대 90초',
    instrumentGrandPiano: '그랜드 피아노',
    instrumentElectricPiano: '일렉트릭 피아노',
    instrumentOrgan: '오르간',
    instrumentHarpsichord: '하프시코드',
    instrumentCelesta: '첼레스타',
    instrumentAcousticGuitar: '어쿠스틱 기타',
    instrumentNylonGuitar: '나일론 기타',
    instrumentElectricGuitar: '일렉트릭 기타',
    instrumentDistortedGuitar: '디스토션 기타',
    instrumentElectricBass: '일렉트릭 베이스',
    instrumentUprightBass: '업라이트 베이스',
    instrumentHarp: '하프',
    instrumentViolin: '바이올린',
    instrumentViola: '비올라',
    instrumentCello: '첼로',
    instrumentDoubleBass: '더블 베이스',
    instrumentStringEnsemble: '스트링 앙상블',
    instrumentPizzicatoStrings: '피치카토 스트링',
    instrumentFlute: '플루트',
    instrumentClarinet: '클라리넷',
    instrumentOboe: '오보에',
    instrumentBassoon: '바순',
    instrumentSaxophone: '색소폰',
    instrumentEnglishHorn: '잉글리시 호른',
    instrumentTrumpet: '트럼펫',
    instrumentTrombone: '트롬본',
    instrumentFrenchHorn: '프렌치 호른',
    instrumentTuba: '튜바',
    instrumentBrassEnsemble: '브라스 앙상블',
    instrumentAcousticDrums: '어쿠스틱 드럼',
    instrumentElectronicDrums: '전자 드럼',
    instrumentDrumMachine: '드럼 머신',
    instrumentPercussion: '퍼커션',
    instrumentTimpani: '팀파니',
    instrumentMarimba: '마림바',
    instrumentVibraphone: '비브라폰',
    instrumentXylophone: '실로폰',
    instrumentSynthLead: '신스 리드',
    instrumentSynthBass: '신스 베이스',
    instrumentSynthPad: '신스 패드',
    instrumentSynthPluck: '신스 플럭',
    recordingLyricsLockedTitle: '녹음 클립에서는 가사 입력이 일시 중지됩니다',
    recordingLyricsLockedHelp: '녹음한 멜로디를 악기 생성용 소스 오디오로 사용합니다. 잘못된 입력을 방지하기 위해 가사 영역을 숨겼습니다.',
    useLyricsAnyway: '그래도 가사 사용',
    stemStart: '스템 시작',
    stemEnd: '스템 끝',
    trackToAdd: '추가할 트랙',
    trackToExtract: '추출할 트랙',
    baseOnly: 'Base 전용',
    sourceAudioRequired: '이 작업에는 소스 오디오 또는 오디오 코드가 필요합니다.',
    baseModelRequired: 'Lego, 추출, 완성 작업에는 Base 모델이 필요합니다.',
    trackSelectionRequired: '생성 전에 트랙을 선택하세요.',
    completeTracksRequired: '완성할 트랙 클래스를 하나 이상 선택하세요.',
    ...
    convertingRecordingToInstrument: '녹음을 악기로 변환하는 중...',
    extendingInstrumentClip: '악기 클립을 확장하는 중 {current}/{total}...',
