...
export const translations = {
  en: {
    ...
    studioDescription: 'A local-first music studio interface customized for ACE-Step 1.5 workflows, focused on generation, interactive lyrics, and library playback.',
    studioCustomization: 'CUSTOM EDITION',
    ...
    originalProjectDescription: 'Built on the ace-step-ui project and powered by ACE-Step 1.5.',
  ...
  zh: {
    ...
    studioDescription: '为 ACE-Step 1.5 工作流定制的本地优先音乐工作室界面，专注于歌曲生成、交互式歌词和音乐库播放。',
    studioCustomization: '定制版本',
    studioCustomizationDescription: '本地 UI/UX 方向、工作流调校，以及 APEXFlow 定制。',
    studioRepo: 'APEXFlow',
    originalProject: '原始项目',
    originalProjectDescription: '基于 ace-step-ui 项目构建，并由 ACE-Step 1.5 驱动。',
    originalRepo: 'ace-step-ui',
    createdBy: '开发者 Ambsd',
  ...
  ja: {
    ...
    studioDescription: 'ACE-Step 1.5 のワークフロー向けにカスタマイズしたローカル優先の音楽スタジオUIです。生成、インタラクティブ歌詞、ライブラリ再生に重点を置いています。',
    studioCustomization: 'カスタム版',
    studioCustomizationDescription: 'ローカルUI/UXの方向性、ワークフロー調整、APEXFlowのカスタマイズ。',
    studioRepo: 'APEXFlow',
    originalProject: 'オリジナルプロジェクト',
    originalProjectDescription: 'ace-step-ui プロジェクトをベースに、ACE-Step 1.5 で動作します。',
    originalRepo: 'ace-step-ui',
    createdBy: '開発者 Ambsd',
  ...
  ko: {
    ...
    studioDescription: 'ACE-Step 1.5 워크플로를 위해 맞춤화된 로컬 우선 음악 스튜디오 UI입니다. 생성, 대화형 가사, 라이브러리 재생에 집중합니다.',
    studioCustomization: '커스텀 버전',
    studioCustomizationDescription: '로컬 UI/UX 방향, 워크플로 튜닝, APEXFlow 커스터마이징.',
    studioRepo: 'APEXFlow',
    originalProject: '원본 프로젝트',
    originalProjectDescription: 'ace-step-ui 프로젝트를 기반으로 하며 ACE-Step 1.5로 구동됩니다.',
    originalRepo: 'ace-step-ui',
    createdBy: '개발자 Ambsd',
